...
public class Resources {
	...
	private static final String
		ID = "",										// Seu ID do Eobot
		API = "",										// Sua chave API encontrada em https://www.eobot.com/profile
		email = "",										// Seu email de cadastro no eobot
		baseURL = "https://www.eobot.com/api.aspx?";	// NÃO ALTERAR, URL utilizada para requisições API
	
	private static final String
		TelegramURL = "",		// Insira a URL fornecida pelo Telegram BotFather na criação do seu bot, ex: https://api.telegram.org/botxxxxxxxxx:AbCdEfGhIjKlMnOpQrStUvWxYz0123456789/
		chatID = "";			// Inicie o chat com o seu bot para obter esse código, mais informações em https://core.telegram.org/bots/api#getting-updates
